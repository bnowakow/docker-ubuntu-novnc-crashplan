...
echo "prev max_user_watches     "`cat /proc/sys/fs/inotify/max_user_watches`
...
echo "prev max_user_instances   "`cat /proc/sys/fs/inotify/max_user_instances`
...
echo "prev file_max             "`cat /proc/sys/fs/file-max`
...
echo "prev max_queued_events    "`cat /proc/sys/fs/inotify/max_queued_events`
...
echo "set                       "`cat /proc/sys/vm/vfs_cache_pressure`
